...
/*package*/ class Definition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new configurationsListHandler_7940ks_a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_configurations");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class configurationsListHandler_7940ks_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public configurationsListHandler_7940ks_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(configurationsListHandler_7940ks_a0.this.getNode(), LINKS.configurations$_2JT));
      try {
